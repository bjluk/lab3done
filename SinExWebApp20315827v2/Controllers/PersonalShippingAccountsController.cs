...
namespace SinExWebApp20315827v2.Controllers
{
    public class PersonalShippingAccountsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShippingAccountId,BuildingInformation,StreetInformation,City,ProvinceCode,PostalCode,PhoneNumber,Email,FirstName,LastName")] PersonalShippingAccount personalShippingAccount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShippingAccountId,BuildingInformation,StreetInformation,City,ProvinceCode,PostalCode,PhoneNumber,Email,FirstName,LastName")] PersonalShippingAccount personalShippingAccount)
        {
            if (ModelState.IsValid)
            {
